...
public class StatementValueNullException extends Exception {
    ...
    private static final String ERROR_MSG = "The value for the %s entry is null.";

    public StatementValueNullException(String entry) {
        super(String.format(ERROR_MSG, entry));
    }
